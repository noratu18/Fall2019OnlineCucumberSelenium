...
Feature: Login
  ...
  #Test Method = Test Case = Scenarion
  ...
  @driver @dashboard
    ...
    #whatever we surround with double quotes we can insert in the stepDefinitions as String
    @login_with_params
    Scenario: Login with parameters
        When user enters "salesmanager110" username and "UserUser123" password
        Then user should verify that title is a Dashboard
